...
export const toggleProfileLoadingAC = (isLoading: boolean) => ({ type: "TOGGLE-PROFILE-LOADING", isLoading }) as const
export const setStatusAC = (status: string) => ({ type: "SET-PROFILE-STATUS", status }) as const
export const setIsFollowAC = (isFollowed: boolean) => ({ type: "SET-IS-FOLLOW", isFollowed }) as const
export const updatePhotosAC = (photos: PhotosType) => ({ type: "UPDATE-PHOTOS", photos }) as const
